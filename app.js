...
function openModal(index) {
    ...
    document.getElementById('modalDateTrailer').textContent = trailer.releaseDateTrailer || 'TBA';
    document.getElementById('modalDateMovie').textContent = trailer.releaseDateMovie || 'TBA';
...
document.addEventListener('DOMContentLoaded', () => {
    syncFromServer().then(renderTrailers);
});
