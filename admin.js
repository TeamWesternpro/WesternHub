...
function renderDashboard() {
    ...
    statsContainer.innerHTML = `
        <div class="stat-card">
            <div class="stat-icon" style="background: rgba(255,0,0,0.15);">🎬</div>
            <div class="stat-info">
        ...
        <div class="stat-card">
            <div class="stat-icon" style="background: rgba(255,0,0,0.15);">⬇️</div>
            <div class="stat-info">
        ...
        recentTrailers.innerHTML = trailers.slice(-3).reverse().map(t => `
            <div class="recent-item">
                ...
                <div class="recent-item-info">
                    ...
                    <span>${t.tag} &middot; ${t.releaseDateMovie || 'TBA'}</span>
                </div>
            </div>
        `).join('');
    }
